...
const cspProd = [
  ...
  "connect-src 'self' https://api.verycodedly.com https://res.cloudinary.com wss: https://www.google-analytics.com https://analytics.google.com https://api.paystack.co https://ipapi.co/json/ https://api.flutterwave.com  https://checkout-v3-ui-prod.f4b-flutterwave.com",
  "frame-src 'self' https://www.youtube.com https://checkout.paystack.com/ https://checkout.flutterwave.com  https://checkout-v3-ui-prod.f4b-flutterwave.com",
