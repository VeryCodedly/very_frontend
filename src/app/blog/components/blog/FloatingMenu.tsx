    ...
    <>
      ...
      <div
        ...
        className={`fixed overflow-hidden pl-6 top-1/2 left-0 transform -translate-y-1/2 bg-white/5 hover:backdrop-blur-lg
                   ...
                   ${expanded ? "w-70 sm:w-70 h-[70%] sm:h-[86%] m:h-full ax-h-[86vh] opacity-100 backdrop-blur-lg" : "opacity-0 w-8 h-10"} z-50`}
      >
        <ul className="flex flex-col gap-1 py-2 text-gray-200 h-full min-h-0 overflow-y-auto ebkit-overflow-scrolling-touc custom-scrollbar">
          {categories.map(cat => {
