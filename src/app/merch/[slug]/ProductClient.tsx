          ...
          <div className="space-y-4">
            <div className="relative">
              <motion.button
                ...
                className="w-full relative overflow-hidden rounded-xl border-b border-gray-600/60 transition-all duration-300 hover:border-gray-500/50 group/btn"
                whileTap={{ scale: 0.99 }}
              >        
              ...
              <AnimatePresence mode="wait">
                {openFit && (
                  ...
                  >
                    <div className="mt-2 bg-white/4 rounded-2xl px-6 md:px-9 py-4">
            ...
            <div className="relative">
              <motion.button
                ...
                className="w-full relative overflow-hidden rounded-xl border-b border-gray-600/60 g-white/3 transition-all duration-300 hover:border-gray-500/50 group/btn"
                whileTap={{ scale: 0.99 }}
              >        
                <div className="relative flex items-center justify-between py-3 px-4 md:px-8">
                  <div className="flex items-center gap-4">
