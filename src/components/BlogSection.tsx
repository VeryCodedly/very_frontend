      ...
      <div className="max-w-6xl mx-auto px-6 text-center">
        ...
        <div className="flex justify-center mt-18">
          <Link
            ...
            className="font-bold cursor-pointer border-3 border-gray-500/100 bg-transparent text-white px-8 py-1 rounded-full hover:bg-white active:bg-white hover:text-black
          ...
          >
            <span className="sr-only">Good Reads</span>
            <span className="lg:hidden">Read</span>
            <span className="hidden lg:inline">Good Reads</span>
          </Link>
        </div>
      </div>
    </section>
