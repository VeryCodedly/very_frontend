...
export default function Hero() {
    return (
        ...
        {/* <section className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center py-16 px-14 md:px-14"> */}
          ...
          <div className="w-full max-w-[400px] min-h-[170px] min-w-[300px] sm:min-h-[230px] sm:min-w-[400px] flex relative">
          <h1 className="hero text-[2.9rem] sm:text-6xl md:text-6xl lg:text-6xl text-white font-extrabold leading-tight">
            <span className="hero opacity-0 w-full max-w-[400px] min-h-[170px] min-w-[300px] sm:min-h-[230px] sm:min-w-[400px] flex absolute">
          ...
          <div className="flex space-x-5">
            <Link href="/learn" className="font-bold cursor-pointer border-3 border-gray-500/100 bg-lime-400 text-black px-6 py-1 rounded-full hover:bg-white active:bg-white hover:text-black
        active:text-black shadow-[0_4px_0_0_#39ff14] hover:shadow-[0_2px_0_0_#39ff14] active:shadow-[0_2px_0_0_#00ff00] active:translate-y-1.5 hover:translate-y-0.5 transition-all duration-200">
            ...
            <Link href="/blog" className="font-bold cursor-pointer border-3 border-gray-500/100 px-7.5 lg:px-8 py-1 rounded-full text-white hover:bg-white active:bg-white hover:text-black
        active:text-black shadow-[0_4px_0_0_#39ff14] hover:shadow-[0_2px_0_0_#39ff14] active:shadow-[0_2px_0_0_#00ff00] active:translate-y-1.5 hover:translate-y-0.5 transition-all duration-200">
