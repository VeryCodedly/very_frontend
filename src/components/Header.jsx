...
export default function Header() {
  ...
  return (
    ...
    ${show ? "translate-y-0" : "-translate-y-full"}`}>
      ...
      <div
        ref={menuRef}
        className={`fixed top-full left-1/2 w-[91.5%] -translate-x-1/2 flex flex-col items-center transform transition-all duration-500 ease-in-out
                bg-black backdrop-blur-lg border-3 border-zinc-700 rounded-4xl py-6.5 space-y-5.5 md:hidden  
