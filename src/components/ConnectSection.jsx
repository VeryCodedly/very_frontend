    ...
    <section className="py-24 bg-transparent order-b border-zinc-900">
      <div className="max-w-6xl mx-auto px-6 text-center">
        <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4">
          Connect on  <span className="text-lime-400">VeryCodedly</span>
        </h2>
        <p className="text-sm sm:text-base text-gray-400 mb-12 max-w-2xl mx-auto">
          No login. No signups. Just a unique handle you'll use in the chat rooms.
        </p>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {[
            ...
            <Link href={`/connect/${room.slug}`} className="group" key={i} aria-label={`${room.slug} room`}>
              <div className="bg-zinc-900/50 rounded-2xl p-6 text-left transition-all duration-300 hover:translate-y-[-5px] 
                  hover:shadow-[0_0_30px_-10px_rgba(154,230,0,0.2)] group-active:translate-y-[-5px] group-active:shadow-[0_0_30px_-10px_rgba(154,230,0,0.2)]"
              >
                ...
                <div className="text-lime-400 font-semibold hover:text-lime-300 group-active:text-lime-300
