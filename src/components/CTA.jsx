        ...
        <div className="text-right md:w-1/2">
          ...
          <div className="flex space-x-4 justify-end">
            <Link
              ...
              className="font-semibold cursor-pointer border-3 border-gray-500/100 px-7 py-1 rounded-full hover:bg-white active:bg-white hover:text-black active:text-black shadow-[0_4px_0_0_#39ff14]
