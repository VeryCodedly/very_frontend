    ...
    <section>
      ...
      {courses.map((course) => {
        ...
        return (
          <div
            key={course.slug}
            className="flex flex-row px-4 py-2.5 sm:px-5 sm:py-3 rounded-2xl shadow bg-zinc-900/40 border-2 border-zinc-900 group hover:-translate-y-[5px] active:-translate-y-[10px] hover:shadow-[0_20px_50px_rgba(0,0,0,0.7)] active:-translate-y-[5px] active:shadow-[0_20px_50px_rgba(0,0,0,0.7)] transition transform duration-300 gap-4 sm:gap-5 mb-2"
          >
            <div className="flex-1 flex flex-col justify-between">
              ...
              <Link href={`/learn/${course.slug}`} aria-label={`Link for ${course.title}`}>
                ...
                <div className="flex items-center justify-between text-sm mt-2">
                  <span className="text-lime-400 font-semibold group-hover:text-white group-active:text-white flex items-center gap-2">
