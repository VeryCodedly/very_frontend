...
export default function NewsletterCard() {
  ...
  return (
    <Motion.div
      ...
      className="fixed bottom-21 right-7 sm:bottom-5.5 sm:right-8 max-w-[80vw] sm:max-w-md rounded-xl border-2 
    ...
    >
      ...
      <form onSubmit={handleSubmit} noValidate className="space-y-4">
        ...
        >
          <button
            type="submit"
            className="w-[30%] sm:w-[36%] px-2 sm:px-4 py-1 mt-4 font-bold text-black bg-lime-400 border-3 border-gray-500/100 rounded-full hover:bg-white active:bg-white hover:text-black 
