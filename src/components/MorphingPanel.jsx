...
const logos = [
  ...
  { src: "/logos/postgresql.svg", alt: "Java" },
...
export default function MorphingPanel({ className = "" }) {
  ...
  const getFaceTransform = (index) => {
    switch (index) {
      ...
      case 0: return "rotateX(-20deg) rotateY(45deg) translateZ(100px)";     // Front
    ...
    <div className="relative flex items-center justify-center w-[205px] h-[205px] perspective-[900px] mx-auto" aria-label="Logo cube">
      ...
      >
        ...
        {groupedLogos.map((group, faceIndex) => (
          <div
            key={faceIndex}
            className="absolute w-full h-full bg-black/10 border-1 border-black/40 rounded-2xl flex flex-col items-center justify-center gap-2 backdrop-blur-xl ring-3 ring-lime-400/30 hover:ring-lime-400/60 active::ring-lime-400/60 inset-0 z-[-1]
        ...
        >
          ...
          >
            ...
            <p className="mb-4 text-gray-300 text-xs">
              <strong>You found the core.</strong> <br />
              These logos are more than tools, they’re the stack that powers this space. We're glad you’re part of it.
            </p>
