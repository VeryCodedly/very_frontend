...
export default function TopicClient({ title, description, media }: Props) {
    return (
        <main className="relative w-full bg-gradient-to-b from-black to-zinc-950/30 text-white min-h-screen py-7 px-6">
            <motion.div
            ...
            <section className="max-w-5xl mx-auto min-h-screen bg-black text-white pb-12">
                {/* Header */}
                <div className="mt-8 mb-14">
                    ...
                    <p className="italic text-md text-left text-gray-400 mt-6 mb-7 w-fit">
                        {description}
                    </p>
                    <p className="ml-1 text-md text-left text-gray-400 mt-6 mb-10 w-fit border-l-4 border-lime-400 rounded-sm pl-4 sm:pl-4">
                        {media.length} video{media.length !== 1 && "s"}
                    </p>
                </div>

                <div className="group/bar px-1">
