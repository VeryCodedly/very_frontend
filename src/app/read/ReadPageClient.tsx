        ...
        <section className="py-20 px-6 bg-black/50 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
            ...
            <Link
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-sm sm:text-base inline-flex items-center gap-3 bg-indigo-600 hover:bg-indigo-700 text-white font-medium py-3 px-8 rounded-lg transition"
            >
              <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
